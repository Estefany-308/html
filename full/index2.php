			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<!-- Empleados -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Empleados</div> <i class="icon-menu" title="Main"></i></li>
						<!--<li class="nav-item">
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-pencil3"></i> <span>Menu</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								<li class="nav-item"><a href="form_inputs.php" class="nav-link">Editar</a></li>
						...
						<li class="nav-item"><a href="form_input_groups.php" class="nav-link">Lista de empleados</a></li>
				...
				<!-- Components -->
					<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Botones</div> <i class="icon-menu" title="Components"></i></li>
						<li class="nav-item nav-item-menu">
							<!--<a href="#" class="nav-link"><i class="icon-grid"></i> <span>Eliminar</span></a>
							<ul class="nav nav-group-sub" data-menu-title="Basic components">/-->		
					<li class="nav-item"><a href="components_modals.php" class="nav-link">Opciones de seleccion</a></li>
						...
						<!-- Extensions -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">E</div> <i class="icon-menu" title="Extensions"></i></li>
						<li class="nav-item nav-item-submenu">
								<li class="nav-item"><a href="extension_image_cropper.php" class="nav-link">Agregar y enlistar</a></li>
						...
						<li class="nav-item nav-item-submenu">/-->
					<!--<a href="#" class="nav-link"><i class="icon-table2"></i> <span>listado de empleados</span></a>
						...
						<!--</li>/-->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Empleados</div> <i class="icon-menu" title="Components"></i></li>
					<li class="nav-item nav-item-menu">
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-puzzle4"></i> <span>Vacaciones</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Extensions">
								<li class="nav-item"><a href="general_feed.php" class="nav-link">Datos sobre las vacaciones</a></li>
