...
<head>
    ...
    <a href="containert" class="btn btn-icon btn-float
					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Basic components">
								<li class="nav-item"><a href="components_modals.html" class="nav-link active">Modals</a></li>
		...
		<div class="content-wrapper">
			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Components</span> - Opciones</h4>
				...
				<div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
					<div class="d-flex">
						<div class="breadcrumb">
							...
							<a href="components_modals.html" class="breadcrumb-item">Components</a>
							<span class="breadcrumb-item active">opciones en chiquito</span>
						</div>
			...
			<div class="content">
				...
				<div class="card">
					...
					<div class="card-body">
						Lee detenidamente cada una de las opciones para que puedas tener la accion que quieres.
					</div>
					...
					<div class="table-responsive">
						<table class="table">
							<tbody>
								<tr>
									<th colspan="3" class="table-active">Selecciona</th>
								</tr>
								<tr>
									<td style="width: 20%;">Agregar datos</td>
									<td style="width: 20%;"><button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_default">Aceptar <i class="icon-play3 ml-2"></i></button></td>
									<td></td>
								</tr>
								<tr>
									<td>¿deseas eliminar todos los datos?</td>
									<td><button type="button" class="btn btn-light" data-toggle="modal" data-target="#modal_iconified">Aceptar<i class="icon-play3 ml-2"></i></button></td>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<h6 class="font-weight-semibold">¿Deseas agregar adtos?</h6>
								<p>Si quieres agregar los datos presina el boton de abajo.</p>

								<hr>

								<h6 class="font-weight-semibold">Otra seccion de texto</h6>
								<p>Por que estoy estudiando esta carrera?.</p>
							</div>

							<div class="modal-footer">
								<button type="button" class="btn btn-link" data-dismiss="modal">Cerrar y dejar de estudiar</button>
								<button type="button" class="btn bg-primary">Guardar cambios y seguir estudiando</button>
							</div>
						</div>
					</div>
				</div>
